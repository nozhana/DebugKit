...
extension URLSession {
    /// Shared debugging `URLSession` object.
    ///
    /// All requests made using this instance will be monitored in the Debug Menu.
    ///
    /// If you need to create a custom `URLSession` instance, use the ``Foundation/URLSessionConfiguration/debug`` configuration like so:
    /// ```swift
    /// // Simple instance
...
extension URLSessionConfiguration {
    /// Shared debugging `URLSessionConfiguration` object.
    ///
    /// All sessions created using this configuration will be monitored in the Debug Menu.
    ///
    /// If you don't need to create a separate `URLSession` instance, check out the shared ``Foundation/URLSession/debug`` session.
    ///
